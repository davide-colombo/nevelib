"""In-memory BLAST hit normalization, selection and inclusive region merging."""
...
# Retain the historical import paths used by serialized public records/callables.
BlastHit.__module__ = "nevelib.search.hits"
_hit_field_value.__module__ = "nevelib.search.hits"
normalize_blast_strand.__module__ = "nevelib.search.hits"
_coverage_from_hit.__module__ = "nevelib.search.hits"
filter_hits.__module__ = "nevelib.search.hits"
select_best_hit_per_query.__module__ = "nevelib.search.hits"
_contained_unique_intervals.__module__ = "nevelib.search.hits"
prune_contained_intervals.__module__ = "nevelib.search.hits"
merge_blast_hits_to_regions.__module__ = "nevelib.search.hits"
filter_hits_by_bitscore_fraction.__module__ = "nevelib.search.hits"
